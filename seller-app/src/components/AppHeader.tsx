...
/**
 * Sotuvchi sahifa header'i — brand orange.
 * Compact rejimda yashiriladi (Telegram bot header'i dublikat bo'lmasligi
 * uchun). Fullscreen'da paydo bo'ladi. Browser'da doim ko'rinadi.
 */
